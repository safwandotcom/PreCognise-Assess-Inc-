      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        ...
        <div className="flex gap-2 shrink-0">
          <Link
            ...
            className="flex items-center gap-2 rounded-lg border border-[#E2E8F0] bg-white px-4 py-2 text-sm font-medium text-[#6366F1] shadow-sm hover:bg-[#F1F5F9] transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-[#E2E8F0] bg-white px-4 py-2 text-sm font-medium text-[#64748B] shadow-sm hover:bg-[#F1F5F9] transition-colors"
          >
          <svg
            className="h-4 w-4"
            fill="none"
