      ...
      <nav className="sticky top-0 z-50 border-b border-[#E2E8F0] bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          <div className="flex items-center gap-3">
            <Image src="/precognise_logo_new.png" alt="PreCognise" width={140} height={32} priority className="h-8" style={{ width: "auto" }} />
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-14 px-6 py-14 md:grid-cols-2">
          ...
          <div>
            <div className="mb-6 flex items-center gap-2.5">
              <Image src="/precognise_logo_new.png" alt="PreCognise" width={120} height={28} className="h-7" style={{ width: "auto" }} />
      ...
      <section className="border-y border-[rgba(46,11,252,0.1)] bg-[#EEF2FF] px-6 py-20">
        <div className="mx-auto grid max-w-6xl gap-20 md:grid-cols-2">
          <div className="flex flex-col gap-5">
            <Image src="/precognise_logo_new.png" alt="PreCognise" width={140} height={32} className="h-8" style={{ width: "auto" }} />
      ...
      <footer className="bg-[#0F172A] px-6 py-9">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-2.5">
            <Image src="/precognise_logo_new.png" alt="PreCognise" width={110} height={26} className="h-6 brightness-0 invert opacity-60" style={{ width: "auto" }} />
