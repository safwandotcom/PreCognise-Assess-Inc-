...
<body style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px 16px;color:#0F172A;">
  <div style="background:linear-gradient(135deg,#6366F1 0%,#4F46E5 100%);border-radius:12px;padding:24px;text-align:center;margin-bottom:24px;">
    <h1 style="color:white;margin:0;font-size:20px;">${esc(orgName)}</h1>
  ...
  <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:8px;padding:16px;margin-bottom:24px;">
    <div style="margin-bottom:12px;">
      ...
      <p style="margin:0;font-family:monospace;font-size:22px;font-weight:700;letter-spacing:2px;">${esc(accessId)}</p>
    </div>
    <div>
      <p style="margin:0 0 4px;font-size:12px;color:#64748B;font-weight:500;text-transform:uppercase;">Temporary Password</p>
      <p style="margin:0;font-family:monospace;font-size:22px;font-weight:700;letter-spacing:2px;">${esc(password)}</p>
    </div>
  </div>
...
<body style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px 16px;color:#0F172A;">
  ...
  <p style="color:#64748B;margin:0 0 24px;font-size:14px;">Hi ${esc(name)}, use the code below to reset your password. It expires in 15 minutes.</p>
  <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:8px;padding:24px;text-align:center;margin-bottom:24px;">
    ...
    <p style="margin:0;font-family:monospace;font-size:40px;font-weight:700;letter-spacing:10px;">${esc(code)}</p>
  </div>
